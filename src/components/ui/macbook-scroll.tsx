...
import dashboard from "../../assets/pc.png"
import {
  IconBrightnessDown,
  IconBrightnessUp,
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center pt-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            Controla todo tu negocio desde nuestro Software
          </span>
        )}
      </motion.h2>
      {/* Lid */}
